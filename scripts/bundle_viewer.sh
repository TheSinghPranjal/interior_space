...
premium_wardrobe = Path('premium_wardrobe.js').read_text()
...
premium_sedan_car = Path('premium_sedan_car.js').read_text()
...
bundle = (
    ...
    .replace('<!-- INJECT_PREMIUM_WARDROBE -->', f'<script>\n{premium_wardrobe}\n</script>')
    ...
    .replace('<!-- INJECT_PREMIUM_SEDAN_CAR -->', f'<script>\n{premium_sedan_car}\n</script>')
